        ...
        <div>
            <header className='Navbar'>
                <div className='Navbar_Logo'>
                    <AcUnitIcon style={{ fontSize: 23 }} color="primary" ></AcUnitIcon>
                ...
                <div className='Navbar_Side'>
                    <IconButton> <ContactMailIcon style={{ fontSize: 20 }} /> </IconButton>
                    <IconButton aria-label="delete"> <AddIcon style={{ fontSize: 20 }} /> </IconButton>
